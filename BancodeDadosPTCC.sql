...
INSERT INTO Filho (nome, data_nascimento, diagnostico, medicamento, tratamentos) 
VALUES
...
INSERT INTO Medico (nome, especialidade, crm, localizacao) 
VALUES
...
INSERT INTO Cadastro (nome, data_nascimento, endereco, cpf, rg, responsavel, id_filho) 
VALUES
...
INSERT INTO Dados_Sociais (cad_unico, crea, bolsa_familia, loas, beneficios, id_cadastro) VALUES
('CU123456', 'CREA001', TRUE, FALSE, 'Benefício A', 1),
('CU234567', 'CREA002', FALSE, TRUE, 'Benefício B', 2),
('CU345678', 'CREA003', TRUE, TRUE, 'Benefício C', 3),
('CU456789', 'CREA004', FALSE, FALSE, 'Benefício D', 4),
('CU567890', 'CREA005', TRUE, TRUE, 'Benefício E', 5),
('CU678901', 'CREA006', FALSE, FALSE, 'Benefício F', 6),
('CU789012', 'CREA007', TRUE, FALSE, 'Benefício G', 7),
('CU890123', 'CREA008', FALSE, TRUE, 'Benefício H', 8),
('CU901234', 'CREA009', TRUE, TRUE, 'Benefício I', 9),
('CU012345', 'CREA010', FALSE, FALSE, 'Benefício J', 10),
('CU123457', 'CREA011', TRUE, FALSE, 'Benefício K', 11),
('CU234568', 'CREA012', FALSE, TRUE, 'Benefício L', 12),
('CU345679', 'CREA013', TRUE, TRUE, 'Benefício M', 13),
('CU456780', 'CREA014', FALSE, FALSE, 'Benefício N', 14),
('CU567891', 'CREA015', TRUE, TRUE, 'Benefício O', 15),
('CU678902', 'CREA016', FALSE, FALSE, 'Benefício P', 16),
('CU789013', 'CREA017', TRUE, FALSE, 'Benefício Q', 17),
('CU890124', 'CREA018', FALSE, TRUE, 'Benefício R', 18),
('CU901235', 'CREA019', TRUE, TRUE, 'Benefício S', 19),
('CU012346', 'CREA020', FALSE, FALSE, 'Benefício T', 20);
